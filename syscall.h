...
//WET2 CHANGE!! - ADDITIONS OF DECLARATIONS OF THE WRAPPERS //
extern asmlinkage int sys_is_SHORT(int pid);
extern asmlinkage int sys_remaining_time(int pid);
extern asmlinkage int sys_remaining_trials(int pid);
